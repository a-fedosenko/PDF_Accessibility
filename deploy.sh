...
deploy_ui() {
    ...
    if ! git clone -b main https://github.com/a-fedosenko/PDF_accessability_UI "$UI_TEMP_DIR" 2>/dev/null; then
...
GITHUB_URL="https://github.com/a-fedosenko/PDF_Accessibility.git"
